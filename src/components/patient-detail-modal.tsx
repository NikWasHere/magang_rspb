...
interface PatientDetailModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSave?: (data: { dokter_id: number | null; catatan: string }) => Promise<void>;
}
      ...
      <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-600">No. KK</label>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm font-medium text-gray-600">No. Antrian</label>
                    <p className="text-gray-900 font-semibold text-lg">{registration.queue_number}</p>
                  </div>
                  <div>
              ...
              {(registration.status === 'dipanggil' || registration.status === 'selesai') && (
                <div>
                  <h3 className="text-lg font-semibold mb-4">Data Pemeriksaan</h3>
                        ...
                        >
                          ...
                          {dokters.map((dokter) => (
                            <option key={dokter.id} value={dokter.id}>
                              {dokter.name} ({dokter.specialization})
                            </option>
                          ))}
                        </select>
                      )}
              ...
              {/* Documents */}
              {(registration.photo_ktp || registration.photo_kk || registration.more_document) && (
                <div>
                  <h3 className="text-lg font-semibold mb-4">Dokumen</h3>
                  <div className="space-y-2">
                    {registration.photo_ktp && (
                      <a
                        href={registration.photo_ktp}
                        target="_blank"
                    ...
                    {registration.more_document && (
                      <a
                        href={registration.more_document}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-blue-600 hover:underline block"
                      >
            ...
            <div className="text-center py-8 text-gray-500">Gagal memuat data</div>
          )}
        </div>
