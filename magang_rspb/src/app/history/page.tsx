...
export default function HistoryPage() {
  ...
  const [selectedRecord, setSelectedRecord] = useState<Registration | null>(
    null
  );
  ...
  const fetchHistory = async () => {
    try {
      ...
      const completed = data.filter(
        (r: any) =>
          r.status === "selesai" && userId !== null && r.user_id === userId
      );
  ...
  const filterHistory = () => {
    if (selectedPoli === "all") {
      ...
      setFilteredHistory(history.filter((r) => r.polis?.name === selectedPoli));
    }
  };
        ...
        <div className="bg-white rounded-xl shadow-lg border-0 mb-6">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-gray-600">
              Lihat riwayat kunjungan dan perawatan Anda
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-lg border-0 p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">
              Anda belum memiliki riwayat pendaftaran yang selesai.
            </p>
            <Link
              href="/daftar"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-900">
                        ...
                        {selectedRecord.dokters?.specialization &&
                          ` (${selectedRecord.dokters.specialization})`}
                      </p>
                    </div>
                    <div>
