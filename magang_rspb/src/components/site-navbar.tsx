            ...
            <>
              <div className="flex items-center gap-3">
                <div className="relative" ref={menuRef}>
                  ...
                  >
                    <div className="w-10 h-10 relative rounded-full overflow-hidden bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center">
                      {user.image ? (
